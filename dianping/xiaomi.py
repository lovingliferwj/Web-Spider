...
class ShopreviewSpider(BaseSpider):
    ...
    def __init__(self):
        self.pageno=0
        self.start_urls = ['http://item.m.jd.com/ware/comments.json?wareId=1514794&score=&sid=d5d08a7af9d3a6c0a1d5ea81df5c1a13&page=%s'%self.pageno]
    ...
    def parse(self, response):
        if response.status == 403:
            ...
            self.pageno+=1
            if self.pageno<=300:
                new_url = 'http://item.m.jd.com/ware/comments.json?wareId=1514794&score=&sid=d5d08a7af9d3a6c0a1d5ea81df5c1a13&page=%s'%self.pageno
